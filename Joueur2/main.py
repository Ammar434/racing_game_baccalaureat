...
class Game:
    def __init__(self):
        pg.init()
        self.screen = pg.display.set_mode((WIDTH, HEIGHT))#creation de la fenetre
...
"""
    ...
    def new(self):
        #initialise toutes les variable et met tout en place pour un nouveau jeu
        ...
        for tile_object in self.map.tmxdata.objects:
            ...
            if tile_object.name == 'player2':
                self.player2 = Player1(self, tile_object.x, tile_object.y,self.screen,self.map_img)
